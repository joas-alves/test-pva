...
export default function ServicePage() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const response = await axios.get(`/${router.locale}/service-content/2`);
  ...
  return (
    <div className="flex flex-col gap-0 md:gap-20">
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to the Premier Vet Alliance Training Academy, a tailored service to support you with a broad catalogue of content and training packages"
        ></meta>
        <link
          rel="canonical"
          href="https://premiervetalliance.com/uk/services/training/"
        ></link>
        <meta property="og:locale" content="en_US"></meta>
        <meta property="og:type" content="article"></meta>
        <meta
          property="og:title"
          content="Premier Vet Alliance Training Academy"
        ></meta>
        <meta
        ...
        <meta
          property="og:url"
          content="https://premiervetalliance.com/uk/services/training/"
        ></meta>
      ...
      {/*<RealStoriesSection />*/}
      <FAQSection data={(tq.raw("training") as IFaq[]).map((item) => ({
        ...item,
        id: Math.random(),
        homepage_id: "",
        created_at: "",
