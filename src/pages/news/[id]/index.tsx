      ...
      <section className="max-w-[846px] mx-auto text-base md:text-xl pt-6">
        <div className="flex justify-between md:items-center flex-col md:flex-row gap-6 mb-3 md:mb-0">
          ...
          <div className="flex items-center text-secondary gap-1">
            ...
            <span className="text-xs sm:text-base">Jul 19, 2024 • 12 min read</span>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-6 md:gap-10">
          ...
          <div>
            <div className="text-xl md:text-[32px] font-bold mb-5">In this article:</div>
            <div className="text-info font-semibold gap-3 md:gap-4 flex flex-col border-l border-l-4 border-l-info pl-4 md:pl-6 py-2">
          ...
          <div>
            <div className="text-xl md:text-[32px] font-bold mb-4 md:mb-5">Reputation is (nearly) everything!</div>
            <p>
          ...
          <div>
            <div className="text-xl md:text-[32px] font-bold mb-4 md:mb-5">Online presence</div>
            <p>
          ...
          <div>
            <div className="text-xl md:text-[32px] font-bold mb-4 md:mb-5">Accessibility</div>
            <p>
          ...
          <div>
            <div className="text-xl md:text-[32px] font-bold mb-4 md:mb-5">Make it easy for owners to do the right things</div>
            <p>
          ...
          <div>
            <div className="text-xl md:text-[32px] font-bold mb-4 md:mb-5">Keeping up appearances</div>
            <p>
          ...
          <div>
            <div className="text-xl md:text-[32px] font-bold mb-4 md:mb-5">Conclusion</div>
            <p>
