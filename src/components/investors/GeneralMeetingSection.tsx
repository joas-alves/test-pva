...
export const GeneralMeetingSection = () => {
  ...
  const downloadPdf = (download: boolean, link: string) => {
    if (download) {
      const linkElement = document.createElement('a');
      linkElement.href = link;
      linkElement.download = 'dummy.pdf';
    ...
    <section className="container mx-auto py-10">
      ...
      <div className="flex justify-between flex-col md:flex-row border-b border-b-gray-200 py-10">
        ...
        <div className="max-w-[847px] w-full flex flex-col gap-4">
          <MeetingLink name="2024-AGM-Notice-Final" downloadPdf={()=>{}} />
          <MeetingLink name="2023-PVG-Annual-Report-FINAL" downloadPdf={downloadPdf} />
          <MeetingLink name="2024-AGM-Votes-Final" downloadPdf={downloadPdf} />
        </div>
      </div>
      ...
      <div className="flex justify-between flex-col md:flex-row border-b border-b-gray-200 py-10">
        ...
        <div className="max-w-[847px] w-full flex flex-col gap-4">
          <MeetingLink name="2024-AGM-Notice-Final" downloadPdf={downloadPdf} />
          <MeetingLink name="2023-PVG-Annual-Report-FINAL" downloadPdf={downloadPdf} />
          <MeetingLink name="2024-AGM-Votes-Final" downloadPdf={downloadPdf} />
        </div>
      </div>
