      ...
      <div className="container mx-auto">
        ...
        <div className="flex gap-6 justify-between w-full sm:w-3/5 text-white -mt-[19%]">
          <div className="flex flex-col items-center">
            ...
            <div className="text-sm md:text-lg font-light">{t('practices')}</div>
          </div>
          <div className="flex flex-col items-center">
            <div className="text-[48px] md:text-[120px] font-bold">6</div>
            <div className="text-sm md:text-lg font-light">{t('countries')}</div>
          </div>
          <div className="flex flex-col items-center">
            <div className="text-[48px] md:text-[120px] font-bold">2</div>
            <div className="text-sm md:text-lg font-light">{t('continents')}</div>
          </div>
        </div>
      </div>
    </section>
