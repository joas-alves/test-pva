      ...
      <div className="flex flex-col md:flex-row gap-10 sm:gap-6">
        <div className="flex flex-col">
          ...
          <div className="flex-1 flex">
            <div className="flex flex-col">
              <p
                className="body text-secondary max-w-[517px] mb-3 sm:mb-6"
        ...
        <div className="flex-shrink-0">
          ...
          <div
            className={
              "flex gap-3 self-center items-center justify-center lg:block "
            }
          >
            <Image
              className="block md:hidden w-[40%] self-center lg:self-auto lg:w-full"
              src={imageUrl(data.section1_image2)}
              width={327}
              height={240}
              alt="dog"
            />
            <Image
              className="w-[120px] h-[160px] lg:hidden"
              src={imageUrl(data.section1_image1)}
              width={301}
              height={365}
              alt="dog"
